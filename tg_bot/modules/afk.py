...
__help__ = """
 - /afk <reason>: menandai anda AFK(away from keyboard).
 - brb <reason>: sama seperti command AFK - tapi ini bukan command.
Ketika anda AFK, setiap mention kepada anda akan dijawab sedang tidak tersedia!
"""
